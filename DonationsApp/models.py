...
class Profile(models.Model):
    ROLE_CHOICES = [('donor', 'Donor'), ('recipient', 'Recipient'),('admin', 'Admin')]
    GENDER_CHOICES = [
        ('M', 'Male'),
        ('F', 'Female'),
        ('O', 'Other'),
...
class Campaign(models.Model):
    ...
    category = models.CharField(max_length=30, choices=CATEGORY_CHOICES)  # ✅ Add this line
...
class Donation(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True)  # ✅ Added user link
...
class Organization(models.Model):
    ...
    category = models.CharField(max_length=50, choices=CATEGORY_CHOICES,default='temple')
...
class RecipientRequest(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    aadhaar_number = models.CharField(max_length=12,default='00000000000')
